...
//     log_trace(tt::LogMetal, "Reading telemetry data for device {}, ethernet core {}", device->id(),
//     eth_logical_core);
...
//         log_warning(
//             tt::LogTest, "Invalid telemetry data for device {}, ethernet channel {}", device->id(),
//             eth_logical_core);
//         return std::nullopt;
//     }
...
//             if (!bw_telemetry) {
//                 log_warning(
//                     tt::LogMetal, "No telemetry data for device {}, ethernet core {}", device->id(),
//                     eth_logical_core);
//                 continue;
//             }
