...
model_traced_params = loader.get_suite_parameters("max_pool2d_short_sweep")
# To run all combinations: loader.get_suite_parameters("max_pool2d_short_sweep", all_cases=True)
