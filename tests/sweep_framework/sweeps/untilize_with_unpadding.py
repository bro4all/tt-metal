...
# To run all combinations: loader.get_suite_parameters("untilize_with_unpadding", all_cases=True)
...
def run(
    ...
    *,
    ...
    for s in input_shape:
        end_shape.append(random.randint(0, s - 1))
    ...
    result = ttnn.untilize_with_unpadding(input_tensor_a, end_shape, memory_config=output_memory_config)
