...
model_traced_params = loader.get_suite_parameters("logaddexp_bw_sharded")
# To run all combinations: loader.get_suite_parameters("logaddexp_bw_sharded", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.logaddexp_bw(grad_tensor, input_tensor_a, input_tensor_b, memory_config=sharded_config)
