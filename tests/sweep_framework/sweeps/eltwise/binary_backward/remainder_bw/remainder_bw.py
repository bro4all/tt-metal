...
model_traced_params = loader.get_suite_parameters("remainder_bw")
# To run all combinations: loader.get_suite_parameters("remainder_bw", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensors = ttnn.remainder_bw(grad_tensor, input_tensor_a, input_tensor_b, memory_config=output_memory_config)
