...
# To run all combinations: loader.get_suite_parameters("sub_bw", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensors = ttnn.sub_bw(grad_tensor, input_tensor_a, input_tensor_b, memory_config=output_memory_config)
