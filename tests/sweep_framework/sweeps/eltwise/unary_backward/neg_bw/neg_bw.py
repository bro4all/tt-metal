...
# To run all combinations: loader.get_suite_parameters("neg_bw", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.neg_bw(grad_tensor, input_tensor_a, memory_config=output_memory_config)[0]
