...
model_traced_params = loader.get_suite_parameters("hardsigmoid_bw_sharded")
# To run all combinations: loader.get_suite_parameters("hardsigmoid_bw_sharded", all_cases=True)
