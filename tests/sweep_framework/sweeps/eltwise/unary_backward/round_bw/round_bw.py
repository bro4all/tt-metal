...
model_traced_params = loader.get_suite_parameters("round_bw")
# To run all combinations: loader.get_suite_parameters("round_bw", all_cases=True)
...
def invalidate_vector(test_vector) -> Tuple[bool, Optional[str]]:
    ...
    if test_vector["input_a_layout"] == ttnn.ROW_MAJOR_LAYOUT and (
...
def run(
    ...
    *,
    ...
    intermediate_result = torch.round(torch_input_tensor_a)
    ...
    output_tensor = ttnn.round_bw(grad_tensor, input_tensor_a, memory_config=output_memory_config)[0]
