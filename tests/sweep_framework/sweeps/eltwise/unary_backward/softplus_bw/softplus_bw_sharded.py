...
model_traced_params = loader.get_suite_parameters("softplus_bw_sharded")
# To run all combinations: loader.get_suite_parameters("softplus_bw_sharded", all_cases=True)
...
def run(
    ...
    *,
    ...
    result = ttnn.softplus_bw(
        grad_tensor, input_tensor_a, beta=beta, threshold=threshold, memory_config=sharded_config
    )[0]
