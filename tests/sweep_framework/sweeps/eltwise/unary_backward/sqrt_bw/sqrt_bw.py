...
# To run all combinations: loader.get_suite_parameters("sqrt_bw", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.sqrt_bw(grad_tensor, input_tensor_a, memory_config=output_memory_config)[0]
