...
model_traced_params = loader.get_suite_parameters("leaky_relu_bw_sharded")
# To run all combinations: loader.get_suite_parameters("leaky_relu_bw_sharded", all_cases=True)
