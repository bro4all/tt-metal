...
model_traced_params = loader.get_suite_parameters("clip_bw_sharded")
# To run all combinations: loader.get_suite_parameters("clip_bw_sharded", all_cases=True)
...
def run(
    ...
    *,
    ...
    result = ttnn.clip_bw(grad_tensor, input_tensor_a, low, high, memory_config=sharded_config)[0]
