...
model_traced_params = loader.get_suite_parameters("acosh_bw_sharded")
# To run all combinations: loader.get_suite_parameters("acosh_bw_sharded", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.acosh_bw(grad_tensor, input_tensor, memory_config=sharded_config)[0]
