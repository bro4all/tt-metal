...
# To run all combinations: loader.get_suite_parameters("rsqrt_bw", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.rsqrt_bw(grad_tensor, input_tensor_a, memory_config=output_memory_config)[0]
