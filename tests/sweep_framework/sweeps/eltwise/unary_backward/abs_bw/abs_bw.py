...
model_traced_params = loader.get_suite_parameters("abs_bw")
# To run all combinations: loader.get_suite_parameters("abs_bw", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.abs_bw(grad_tensor, input_tensor_a, memory_config=output_memory_config)[0]
