...
# To run all combinations: loader.get_suite_parameters("frac_bw_sharded", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.frac_bw(grad_tensor, input_tensor, memory_config=sharded_config)[0]
