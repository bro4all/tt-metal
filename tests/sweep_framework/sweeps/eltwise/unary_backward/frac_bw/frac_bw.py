...
# To run all combinations: loader.get_suite_parameters("frac_bw", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.frac_bw(grad_tensor, input_tensor_a, memory_config=output_memory_config)[0]
