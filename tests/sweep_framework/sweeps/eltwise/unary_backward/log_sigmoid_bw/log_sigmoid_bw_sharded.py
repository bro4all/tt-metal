...
model_traced_params = loader.get_suite_parameters("log_sigmoid_bw_sharded")
# To run all combinations: loader.get_suite_parameters("log_sigmoid_bw_sharded", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.log_sigmoid_bw(grad_tensor, input_tensor, memory_config=sharded_config)[0]
