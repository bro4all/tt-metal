...
# Ref: https://github.com/tenstorrent/pytorch2.0_ttnn/blob/main/docs/operations/aten.le.Tensor.md
...
model_traced_params = loader.get_suite_parameters("le")
# To run all combinations: loader.get_suite_parameters("le", all_cases=True)
