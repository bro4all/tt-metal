...
model_traced_params = loader.get_suite_parameters("squared_difference")
# To run all combinations: loader.get_suite_parameters("squared_difference", all_cases=True)
