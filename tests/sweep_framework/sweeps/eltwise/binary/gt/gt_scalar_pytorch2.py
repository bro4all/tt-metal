...
# Ref: https://github.com/tenstorrent/pytorch2.0_ttnn/blob/main/docs/operations/aten.gt.Scalar.md
...
# To run all combinations: loader.get_suite_parameters("gt", all_cases=True)
