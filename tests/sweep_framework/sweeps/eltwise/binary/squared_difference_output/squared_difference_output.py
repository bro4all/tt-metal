...
model_traced_params = loader.get_suite_parameters("squared_difference_output")
# To run all combinations: loader.get_suite_parameters("squared_difference_output", all_cases=True)
