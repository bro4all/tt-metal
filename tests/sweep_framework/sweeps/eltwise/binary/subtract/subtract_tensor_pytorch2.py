...
# Ref: https://github.com/tenstorrent/pytorch2.0_ttnn/blob/main/docs/operations/aten.sub.Tensor.md
...
# To run all combinations: loader.get_suite_parameters("subtract", all_cases=True)
