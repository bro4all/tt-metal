...
# To run all combinations: loader.get_suite_parameters("logaddexp2", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.logaddexp2(input_tensor_a, input_tensor_b, memory_config=sharded_config)
