...
# Ref: https://github.com/tenstorrent/pytorch2.0_ttnn/blob/main/docs/operations/aten.remainder.Scalar.md
...
# To run all combinations: loader.get_suite_parameters("remainder", all_cases=True)
