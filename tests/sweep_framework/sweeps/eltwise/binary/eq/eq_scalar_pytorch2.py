...
# Ref: https://github.com/tenstorrent/pytorch2.0_ttnn/blob/main/docs/operations/aten.eq.Scalar.md
...
# To run all combinations: loader.get_suite_parameters("eq", all_cases=True)
