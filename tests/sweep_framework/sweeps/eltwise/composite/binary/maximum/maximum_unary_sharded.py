...
model_traced_params = loader.get_suite_parameters("maximum_unary_sharded")
# To run all combinations: loader.get_suite_parameters("maximum_unary_sharded", all_cases=True)
