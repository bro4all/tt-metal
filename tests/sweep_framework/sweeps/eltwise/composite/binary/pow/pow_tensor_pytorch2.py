...
# Ref: https://github.com/tenstorrent/pytorch2.0_ttnn/blob/main/docs/operations/aten.pow.Tensor_Tensor.md
...
model_traced_params = loader.get_suite_parameters("pow_tensor_pytorch2")
# To run all combinations: loader.get_suite_parameters("pow_tensor_pytorch2", all_cases=True)
