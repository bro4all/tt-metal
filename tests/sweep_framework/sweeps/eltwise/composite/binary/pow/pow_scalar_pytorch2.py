...
model_traced_params = loader.get_suite_parameters("pow_scalar_pytorch2")
# To run all combinations: loader.get_suite_parameters("pow_scalar_pytorch2", all_cases=True)
