...
model_traced_params = loader.get_suite_parameters("exp2")
# To run all combinations: loader.get_suite_parameters("exp2", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.exp2(input_tensor_a, memory_config=sharded_config)
