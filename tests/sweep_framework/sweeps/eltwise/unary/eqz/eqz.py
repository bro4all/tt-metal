...
from models.common.utility_functions import torch_random_with_zeros
...
model_traced_params = loader.get_suite_parameters("eqz")
# To run all combinations: loader.get_suite_parameters("eqz", all_cases=True)
