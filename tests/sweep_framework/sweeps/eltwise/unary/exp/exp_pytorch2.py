...
# Ref: https://github.com/tenstorrent/pytorch2.0_ttnn/blob/main/docs/operations/aten.exp.default.md
...
model_traced_params = loader.get_suite_parameters("exp")
# To run all combinations: loader.get_suite_parameters("exp", all_cases=True)
