...
model_traced_params = loader.get_suite_parameters("acosh")
# To run all combinations: loader.get_suite_parameters("acosh", all_cases=True)
...
def run(
    ...
    *,
    ...
    torch_output_tensor = torch.acosh(torch_input_tensor_a)
    ...
    output_tensor = ttnn.acosh(input_tensor_a, memory_config=sharded_config)
