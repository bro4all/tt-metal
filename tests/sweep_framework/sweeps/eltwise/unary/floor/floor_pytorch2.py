...
# Ref: https://github.com/tenstorrent/pytorch2.0_ttnn/blob/main/docs/operations/aten.floor.default.md
...
# To run all combinations: loader.get_suite_parameters("floor", all_cases=True)
