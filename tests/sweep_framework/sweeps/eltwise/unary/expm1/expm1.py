...
model_traced_params = loader.get_suite_parameters("expm1")
# To run all combinations: loader.get_suite_parameters("expm1", all_cases=True)
...
def run(
    ...
    *,
    ...
    torch_output_tensor = torch.expm1(torch_input_tensor_a)
    ...
    result = ttnn.expm1(input_tensor_a, memory_config=output_memory_config)
