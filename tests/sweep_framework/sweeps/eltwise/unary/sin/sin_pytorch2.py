...
# Ref: https://github.com/tenstorrent/pytorch2.0_ttnn/blob/main/docs/operations/aten.sin.default.md
...
# To run all combinations: loader.get_suite_parameters("sin", all_cases=True)
