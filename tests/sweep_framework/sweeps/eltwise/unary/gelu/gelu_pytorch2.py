...
# Ref: https://github.com/tenstorrent/pytorch2.0_ttnn/blob/main/docs/operations/aten.gelu.default.md
...
# To run all combinations: loader.get_suite_parameters("gelu", all_cases=True)
