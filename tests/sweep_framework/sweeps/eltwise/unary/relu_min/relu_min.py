...
model_traced_params = loader.get_suite_parameters("relu_min")
# To run all combinations: loader.get_suite_parameters("relu_min", all_cases=True)
...
def run(
    ...
    *,
    ...
    result = ttnn.relu_min(input_tensor, lower_limit, memory_config=output_memory_config)
