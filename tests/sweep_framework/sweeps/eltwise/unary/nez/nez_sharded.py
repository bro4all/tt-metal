...
model_traced_params = loader.get_suite_parameters("nez")
# To run all combinations: loader.get_suite_parameters("nez", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.nez(input_tensor_a, memory_config=sharded_config)
