...
# Ref: https://github.com/tenstorrent/pytorch2.0_ttnn/blob/main/docs/operations/aten.elu.default.md
...
model_traced_params = loader.get_suite_parameters("elu")
# To run all combinations: loader.get_suite_parameters("elu", all_cases=True)
