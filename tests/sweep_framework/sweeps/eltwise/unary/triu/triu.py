...
model_traced_params = loader.get_suite_parameters("triu")
# To run all combinations: loader.get_suite_parameters("triu", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.triu(input_tensor_a, diagonal=diagonal, memory_config=output_memory_config)
