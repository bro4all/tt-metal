...
# To run all combinations: loader.get_suite_parameters("sigmoid_accurate", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.sigmoid_accurate(input_tensor_a, memory_config=sharded_config)
