...
# To run all combinations: loader.get_suite_parameters("bitwise", all_cases=True)
...
def run(
    ...
    *,
    ...
    torch_input_tensor_b = gen_func_with_cast_tt(
        partial(torch_random, low=0, high=2147483648, dtype=torch.int64), input_b_dtype
    )(input_shape)
    ...
    result = ttnn.bitwise_and(input_tensor_a, input_tensor_b, memory_config=output_memory_config)
