...
# To run all combinations: loader.get_suite_parameters("softplus", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.softplus(input_tensor_a, beta=beta, threshold=threshold, memory_config=sharded_config)
