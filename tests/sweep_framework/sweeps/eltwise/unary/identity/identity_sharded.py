...
model_traced_params = loader.get_suite_parameters("identity")
# To run all combinations: loader.get_suite_parameters("identity", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.identity(input_tensor_a, memory_config=sharded_config)
