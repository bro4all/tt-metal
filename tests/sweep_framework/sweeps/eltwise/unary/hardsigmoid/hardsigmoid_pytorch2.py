...
# Ref: https://github.com/tenstorrent/pytorch2.0_ttnn/blob/main/docs/operations/aten.hardsigmoid.default.md
...
model_traced_params = loader.get_suite_parameters("hardsigmoid")
# To run all combinations: loader.get_suite_parameters("hardsigmoid", all_cases=True)
