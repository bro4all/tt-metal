...
# Ref: https://github.com/tenstorrent/pytorch2.0_ttnn/blob/main/docs/operations/aten.sigmoid.default.md
...
model_traced_params = loader.get_suite_parameters("sigmoid")
# To run all combinations: loader.get_suite_parameters("sigmoid", all_cases=True)
