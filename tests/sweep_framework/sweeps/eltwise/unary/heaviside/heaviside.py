...
model_traced_params = loader.get_suite_parameters("heaviside")
# To run all combinations: loader.get_suite_parameters("heaviside", all_cases=True)
...
def run(
    ...
    *,
    ...
    output_tensor = ttnn.heaviside(input_tensor_a, value=scalar, memory_config=output_memory_config)
