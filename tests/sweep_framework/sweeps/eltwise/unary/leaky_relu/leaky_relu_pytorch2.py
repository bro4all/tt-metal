...
# Ref: https://github.com/tenstorrent/pytorch2.0_ttnn/blob/main/docs/operations/aten.leaky_relu.default.md
...
# To run all combinations: loader.get_suite_parameters("leaky_relu", all_cases=True)
