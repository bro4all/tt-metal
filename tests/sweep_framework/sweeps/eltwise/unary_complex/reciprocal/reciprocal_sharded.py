...
model_traced_params = loader.get_suite_parameters("reciprocal_sharded")
# To run all combinations: loader.get_suite_parameters("reciprocal_sharded", all_cases=True)
