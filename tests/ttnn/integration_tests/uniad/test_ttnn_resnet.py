...
from models.experimental.uniad.tt.ttnn_resnet import TtBottleneck
            ...
            for block_idx, block in enumerate(layer):
                ...
                for conv_name in ["conv1", "conv2", "conv3"]:
                    ...
                    if isinstance(conv, ModulatedDeformConv2dPack):
                        ...
                        parameters["res_model"][prefix][conv_name]["conv_offset"] = {
...
def test_uniad_bottle_neck(device, reset_seeds):
