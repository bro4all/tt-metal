...
TEST(DirectedRetraining, TestOnDemandCableRestart) {
    ...
    for (const auto& link : links) {
        log_info(tt::LogTest, "Taking down link for ASIC {} channel {}", *link.src_asic_id, link.src_channel);
    ...
    // Build reset topology with all links
