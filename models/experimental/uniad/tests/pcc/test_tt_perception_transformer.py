...
#     mlvl_feats = torch.load("models/experimental/uniad/reference/transformer_inputs/mlvl_feats.pt")
#     bev_queries = torch.load("models/experimental/uniad/reference/transformer_inputs/bev_queries.pt")
#     bev_h = 50
#     bev_w = 50
#     grid_length = (2.048, 2.048)
#     bev_pos = torch.load("models/experimental/uniad/reference/transformer_inputs/bev_pos.pt")
#     prev_bev = None

#     img_metas = torch.load("models/experimental/uniad/reference/transformer_inputs/img_metas_updated.pt")
...
#     # assert_with_pcc(reference_output,torch.load("models/experimental/uniad/reference/transformer_inputs/bev_embed_output.pt"),pcc=1)

#     bev_embed = torch.load("models/experimental/uniad/reference/transformer_inputs/bev_embed.pt")
#     object_query_embed = torch.load("models/experimental/uniad/reference/transformer_inputs/object_query_embed.pt")
#     bev_h = 50
#     bev_w = 50
#     reference_points = torch.load("models/experimental/uniad/reference/transformer_inputs/reference_points.pt")
#     reg_branches = torch.load("models/experimental/uniad/reference/transformer_inputs/reg_branches.pt")
#     cls_branches = None
...
#     assert_with_pcc(
#         reference_output[1],
#         torch.load("models/experimental/uniad/reference/transformer_inputs/init_reference_out_output.pt"),
#         pcc=1,
#     )
#     assert_with_pcc(
#         reference_output[2],
#         torch.load("models/experimental/uniad/reference/transformer_inputs/inter_references_out_output.pt"),
#         pcc=1,
#     )
#     assert_with_pcc(
#         reference_output[0],
#         torch.load("models/experimental/uniad/reference/transformer_inputs/inter_states_output.pt"),
#         pcc=1,
#     )
