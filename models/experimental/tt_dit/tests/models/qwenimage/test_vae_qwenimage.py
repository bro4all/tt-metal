...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param((1, 2), 1, id="1x2tp"),
        pytest.param((1, 8), 1, id="1x8tp"),
    ],
...
def test_vae_qwenimage_norm(
    *,
    ...
    ctx = QwenImageVaeContext(tp_axis=tp_axis, device=mesh_device, ccl_manager=ccl_manager)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # pytest.param((1, 2), id="1x2"),  # gives bad results
