...
def galaxy_or_t3k_mesh(request, device_params):
    """
    Pytest fixture to set up a device mesh for Qwen3MoE tests.
    Many Qwen3MoE submodules operate on a single row of devices,
...
def mesh_row(galaxy_or_t3k_mesh):
    """
    Qwen3MoE runs many modules on a single 8-device row of a Galaxy system.
