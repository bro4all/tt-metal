# models/demos/qwen3_moe/tests/test_expert.py
...
import ttnn
from models.demos.qwen3_moe.reference.modeling_qwen3_moe import Qwen3MoeMLP as ReferenceExpert

# Import from local reference files instead of HuggingFace
from models.demos.qwen3_moe.tt.expert import Expert as TTExpert
...
def test_forward_pass(mode, seq_len, mesh_device, temp_dir, hf_config):
    ...
    logger.info("hf_config = {}", hf_config.hidden_size)
    reference_model = ReferenceExpert(hf_config, intermediate_size=hf_config.moe_intermediate_size)
