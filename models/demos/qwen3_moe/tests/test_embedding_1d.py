# models/demos/qwen3_moe/tests/test_embedding_1d.py
...
import ttnn
from models.demos.qwen3_moe.tt.embedding_1d import Embedding1D
...
def hf_config():
    ...
    print(f"Loading HuggingFace config from: {path}")
...
def reference_model(hf_config):
    """Qwen3MoE just uses the standard Embedding module."""
    return Embedding(
