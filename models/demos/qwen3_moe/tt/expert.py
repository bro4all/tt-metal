...
import ttnn
from models.demos.qwen3_moe.tt.mlp_1d import MLP1D
from models.demos.qwen3_moe.utils.config_dataclass import FromWeightConfig, LinearConfig, MeshDeviceStub, MulConfig
from models.demos.qwen3_moe.utils.config_helpers import COMPUTE_KERNEL_CONFIG_LOFI, even_int_div, save_and_get_path
...
class Expert(MLP1D):  # The only difference with the regular Dequantized MLP is the intermediate layer size
    ...
    def _get_num_experts_per_device(cls, hf_config: PretrainedConfig, mesh_device: ttnn.Device) -> int:
        ...
        return even_int_div(hf_config.num_experts, mesh_device.get_num_devices())
