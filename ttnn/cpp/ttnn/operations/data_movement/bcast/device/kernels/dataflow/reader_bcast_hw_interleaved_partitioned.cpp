...
#ifndef IN0_SHARDED
    // When not sharded: src0 args at offset 0, src1 args at next offset
    constexpr auto src0_tensor_args = TensorAccessorArgs<0>();
    constexpr auto src1_tensor_args = TensorAccessorArgs<src0_tensor_args.next_compile_time_args_offset()>();
...
#else
    // When sharded: only src1 args are passed, at offset 0
